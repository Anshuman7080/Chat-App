...
const EditUserDetails = ({onClose,user}) => {
    ...
    const image=previewImage ? previewImage : user?.profile_pic;
...
formData.append("profile_pic", data.profile_pic); 
 ...
 const response=await dispatch(updateUserDetails(formData,navigate));
if(response?.data?.success){
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 bg-gray-700  bg-opacity-40 flex justify-center items-center z-30 ">
